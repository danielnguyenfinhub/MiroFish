...
class SimulationLogManager:
    ...
    def __init__(self, simulation_dir: str):
        ...
        self.twitter_logger: PlatformActionLogger | None = None
        self.reddit_logger: PlatformActionLogger | None = None
        self._main_logger: logging.Logger | None = None
...
def get_logger(log_path: str | None = None) -> ActionLogger:
    """获取全局日志实例（兼容旧接口）"""
